...
export const fixedText = `TypeRacer is a multiplayer online typing game that allows you to race against other players to see who can type a passage of text the fastest.`;

export const fixedText3 = `online typing game`;
